...
?>
<?php
// echo $_POST['artical_id'];
    $sql = "SELECT * FROM artical where category_id='PODCASTS' AND artical_id=".$_POST['artical_id'];
...
<div class="title">
    ...
    <div class="title">
        ...
        <div class="final_buttons">
                ...
                <a href="#pop"> <button class="publish" id="decision_meme_publish" name="'.$artical_id.'"> PUBLISH </button> </a>
                <button class="publish" id="decision_story_review"> REVIEW </button>
                <button class="delete3" id="'.$artical_id.'"> DELETE </button>
        </div>';
        // echo print_r($row);
        echo $output;
?>
