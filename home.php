...
?>
                ...
                <div class="row mt-3" >
                    <div class="content_box mt-3">
                        ...
                        <?php
                            $sql = "SELECT * FROM `artical` WHERE delete_status=2 ORDER BY `date` DESC LIMIT 4,3";
                            $result = mysqli_query($conn, $sql);
                            while ($row = mysqli_fetch_assoc($result)) {
                            $image = $row['image'];
                            $artical_id = $row['artical_id'];
...
<!-- 
                    ...
                    <?php
                            $sql = "SELECT * FROM `artical` WHERE delete_status=2 ORDER BY `date` DESC LIMIT 7,1";
                            $result = mysqli_query($conn, $sql);
                            while ($row = mysqli_fetch_assoc($result)) {
                            $image = $row['image'];
                            $artical_id = $row['artical_id'];
...
<section class="latest">
            ...
            <div class="story_content  pl-3">
                <div class="row_flex">
                    ...
                    <div class="row row1_story" >
                       ...
                       <!-- 2nd 3rd 4th -->
                        <div class="content_box ">
                            <?php
                                     $sql = "SELECT * FROM `artical` WHERE category_id='STORIES' AND delete_status=2 ORDER BY `date` DESC LIMIT 1,3";
                                     $result = mysqli_query($conn, $sql);
                                     while ($row = mysqli_fetch_assoc($result)) {
                                     $image = $row['image'];
                                     $artical_id = $row['artical_id'];
                    ...
                    <div class="row row1_story mt-5  ml-1" >
                        <?php
                            $sql = "SELECT * FROM `artical` WHERE category_id='STORIES' AND delete_status=2 ORDER BY `date` DESC LIMIT 4,1";
                            $result = mysqli_query($conn, $sql);
                            while ($row = mysqli_fetch_assoc($result)) {
                            $image = $row['image'];
                            $artical_id = $row['artical_id'];
                        ...
                        <div class="content_box ">
                            <?php
                                   $sql = "SELECT * FROM `artical` WHERE category_id='STORIES' AND delete_status=2 ORDER BY `date` DESC LIMIT 5,3";
                                   $result = mysqli_query($conn, $sql);
                                   while ($row = mysqli_fetch_assoc($result)) {
                                   $image = $row['image'];
                                   $artical_id = $row['artical_id'];
                ...
                <div class="row1_flex">
                    ...
                    <div class="mt-5 pl-3">
                    <?php
                                   $sql = "SELECT * FROM `artical` WHERE category_id='STORIES' AND delete_status=2 ORDER BY `date` DESC LIMIT 8,3";
                                   $result = mysqli_query($conn, $sql);
                                   while ($row = mysqli_fetch_assoc($result)) {
                                   $image = $row['image'];
                                   $artical_id = $row['artical_id'];
        ...
        <section class="latest">
            ...
            <div class="enter_content  pl-3 ">
                ...
                <?php
                                   $sql = "SELECT * FROM `artical` WHERE category_id='ENTERTAINMENT' AND delete_status=2 ORDER BY `date` DESC LIMIT 0,2";
                                   $result = mysqli_query($conn, $sql);
                                   while ($row = mysqli_fetch_assoc($result)) {
                                   $image = $row['image'];
                                   $artical_id = $row['artical_id'];
                      ...
                      <?php
                                   $sql = "SELECT * FROM `artical` WHERE category_id='ENTERTAINMENT' AND delete_status=2 ORDER BY `date` DESC LIMIT 2,1";
                                   $result = mysqli_query($conn, $sql);
                                   while ($row = mysqli_fetch_assoc($result)) {
                                   $image = $row['image'];
                                   $artical_id = $row['artical_id'];
                ...
                <div class="row mt-md-5">
                    ...
                    <?php
                                   $sql = "SELECT * FROM `artical` WHERE category_id='ENTERTAINMENT' AND delete_status=2 ORDER BY `date` DESC LIMIT 3,3";
                                   $result = mysqli_query($conn, $sql);
                                   while ($row = mysqli_fetch_assoc($result)) {
                                   $image = $row['image'];
                                   $artical_id = $row['artical_id'];
                    ...
                    <?php
                                   $sql = "SELECT * FROM `artical` WHERE category_id='ENTERTAINMENT' AND delete_status=2 ORDER BY `date` DESC LIMIT 6,3";
                                   $result = mysqli_query($conn, $sql);
                                   while ($row = mysqli_fetch_assoc($result)) {
                                   $image = $row['image'];
                                   $artical_id = $row['artical_id'];
        ...
        <section class="latest">
            ...
            <div class="memes_content    mt-3">
                ...
                <?php
                                   $sql = "SELECT * FROM `artical` where `category_id`='MEMES' AND delete_status=2 ORDER BY `date` DESC LIMIT 6,3";
                                   $result = mysqli_query($conn, $sql);
                                   while ($row = mysqli_fetch_assoc($result)) {
                                   $image = $row['image'];
                                   $artical_id = $row['artical_id'];
