            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body mx-auto">
                        <div class="social">
                            <a href="https://www.whatsapp.com/" id="share-wa" class="sharer button"><i
                                    class="fa fa-3x fa-whatsapp text-success"></i></a>
                            <a href="https://www.facebook.com/" id="share-fb" class="sharer button"><i
                                    class="fa fa-3x fa-facebook-square text-primary"></i></a>
                            <a href="https://twitter.com/login?lang=en" id="share-tw" class="sharer button"><i
                                    class="fa fa-3x fa-twitter-square text-primary"></i></a>
                            <a href="https://www.linkdin.com/in/siddhikdoshi" id="share-li" class="sharer button"><i
                                    class="fa fa-3x fa-linkedin-square text-primary"></i></a>
                            <a href="https://www.google.com" id="share-gp" class="sharer button"><i
                                    class="fa fa-3x fa-google-plus-square text-danger"></i></a>
                            <a href="mailto:" id="share-em" class="sharer button"><i
                                    class="fa fa-3x fa-envelope-square text-dark"></i></a>
                        </div>
                    </div>
        ...
        <div class="meme_particular">
            ...
            <div class="meme_info ">
                ...
                <div class="meme_icon mt-2">
                    ...
                    <span class="meme_bookmark"> <i class="fa fa-bookmark-o save"
                            id="<?php echo $_POST['artical-id']; ?>" aria-hidden="true"></i> </span>
                    <span class="meme_send" aria-hidden="true" data-toggle="modal" data-target="#share">
                ...
                <div class="meme_text text_size">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laboriosam ducimus iste quae repudiandae,
                    fugiat reiciendis labore. Voluptatibus quasi sequi neque et deleniti, laborum, dolorum recusandae
                    libero animi error cupiditate. Corrupti?
                </div>
                ...
                <div class="comments_all text_size  mt-4">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cumque praesentium a soluta labore minus
                    accusamus illum perferendis sit accusantium! Adipisci in ipsa doloribus nulla ex dolorum vel
                    consectetur quo nisi.
                </div>
            </div>
        </div>
        <!------------------------------------------------------row 2 ----------------------------------------------->
        ...
        $.ajax({
            ...
            success: function(data) {
                if ($('.meme_heart i').attr('class') != 'fa fa-heart') {
                    $('.meme_heart i').attr('class', 'fa fa-heart');
                    var temp = Number.parseInt($('.meme_heart p').html()) ? Number.parseInt($(
                        '.meme_heart p').html()) : 0;
