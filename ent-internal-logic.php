...
require "dbconnect.php";
    ...
    $output .=$date.'</h6></div><div class="symbol"><img src="assets/img/logo/label.png" class="black_logo" /><img src="assets/img/logo/white.png" class="white_logo" /><i class="fa fa-share-alt fa-lg mt-1" aria-hidden="true"></i></div></div>';;
